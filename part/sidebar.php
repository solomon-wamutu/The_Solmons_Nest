<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  $ret = "SELECT * FROM  members  WHERE userid = ? ";
  $stmt = $connection->prepare($ret);
  ...
  ?>
      ...
      <a href="dashboard.php" class="brand-link">
        <img src="../admin/dist/img/<?php echo $sys->logo;?>" alt="iBanking Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
